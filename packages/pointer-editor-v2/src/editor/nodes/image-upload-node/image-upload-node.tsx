...
const DropZoneContent: React.FC = () => (
  <>
    ...
    <div className='tiptap-image-upload-content'>
      <span className='tiptap-image-upload-text'>클릭 또는 드래그 앤 드롭으로 이미지 업로드</span>
    </div>
  </>
);
...
export const ImageUploadNode: React.FC<NodeViewProps> = (props) => {
  ...
  // Force single-file upload and no size limit in this component
  const limit = 1;
  const maxSize = 0;
