...
function RouteComponent() {
  ...
  const { selectedList, unselectedList, onClickSelectTag, onClickRemoveTag } =
    useSelectTag()
  const { problemType, answer, handleClickProblemType, handleChangeAnswer } =
    useAnswerInput()
