 ...
 */
export const getScrapsByFolder = (
  queryClient: QueryClient,
  params: GetScrapsByFolderParams,
  queryParams?: GetScrapsByFolderQueryParams
) => {
  return queryClient.fetchQuery(
    TanstackQueryClient.queryOptions('get', '/api/student/scrap/folder/{folderId}/scraps', {
      params: {
        path: params,
        query: queryParams,
      },
...
/**
 * 폴더 내 스크랩 목록 조회
 * @description 특정 폴더에 속한 스크랩 목록을 조회합니다. (useQuery 사용)
 */
