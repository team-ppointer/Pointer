...
const GoogleIcon = React.forwardRef<React.ComponentRef<typeof Svg>, LucideProps>(
  ({ size = 24, ...rest }, ref) => (
    <Svg ref={ref} width={size} height={size} viewBox='0 0 268.1522 273.8827' fill='none' {...rest}>
      <Defs>
        <LinearGradient
          id='s'
          x1='219.6997'
        ...
        <RadialGradient
          ...
          <Stop offset='0.2312727' stopColor='#ff4541' />
          <Stop offset='0.3115468' stopColor='#ff4540' />
          <Stop offset='0.4575163' stopColor='#ff4640' />
          <Stop offset='0.540305' stopColor='#ff473f' />
          <Stop offset='0.6993464' stopColor='#ff5138' />
          <Stop offset='0.7712418' stopColor='#ff5b33' />
          <Stop offset='0.8605665' stopColor='#ff6c29' />
        ...
        <RadialGradient
          ...
          <Stop offset='0.1315461' stopColor='#0cba65' />
          <Stop offset='0.2097843' stopColor='#0bb86d' />
          <Stop offset='0.2972969' stopColor='#09b479' />
          <Stop offset='0.3962575' stopColor='#08ad93' />
          <Stop offset='0.4771242' stopColor='#0aa6a9' />
          <Stop offset='0.5684245' stopColor='#0d9cc6' />
          <Stop offset='0.667385' stopColor='#1893dd' />
          <Stop offset='0.7687273' stopColor='#258bf1' />
          <Stop offset='0.8585063' stopColor='#3086ff' />
        </RadialGradient>
        <RadialGradient
          id='l'
          cx='304.0166'
          ...
          gradientUnits='userSpaceOnUse'>
          <Stop offset='0.4084578' stopColor='#fb4e5a' />
        ...
        <RadialGradient
          ...
          <Stop offset='0.3660131' stopColor='#ff4e3a' />
          <Stop offset='0.4575163' stopColor='#ff8a1b' />
          <Stop offset='0.540305' stopColor='#ffa312' />
          <Stop offset='0.6156363' stopColor='#ffb60c' />
          <Stop offset='0.7712418' stopColor='#ffcd0a' />
          <Stop offset='0.8605665' stopColor='#fecf0a' />
          <Stop offset='0.9150327' stopColor='#fecf08' />
        ...
        <RadialGradient
          ...
          <Stop offset='0.3159041' stopColor='#ff4c3c' />
          <Stop offset='0.6038179' stopColor='#ff692c' />
          <Stop offset='0.7268366' stopColor='#ff7825' />
        ...
        <RadialGradient
          ...
          <Stop offset='0.2312727' stopColor='#0fbc5f' />
          <Stop offset='0.3115468' stopColor='#0fbc5f' />
          <Stop offset='0.3660131' stopColor='#0fbc5e' />
          <Stop offset='0.4575163' stopColor='#0fbc5d' />
          <Stop offset='0.540305' stopColor='#12bc58' />
          <Stop offset='0.6993464' stopColor='#28bf3c' />
          <Stop offset='0.7712418' stopColor='#38c02b' />
          <Stop offset='0.8605665' stopColor='#52c218' />
          <Stop offset='0.9150327' stopColor='#67c30f' />
        ...
        <RadialGradient
          ...
          <Stop offset='0.1416122' stopColor='#1abd4d' />
          <Stop offset='0.2475151' stopColor='#6ec30d' />
          <Stop offset='0.3115468' stopColor='#8ac502' />
          <Stop offset='0.3660131' stopColor='#a2c600' />
          <Stop offset='0.4456735' stopColor='#c8c903' />
          <Stop offset='0.540305' stopColor='#ebcb03' />
          <Stop offset='0.6156363' stopColor='#f7cd07' />
          <Stop offset='0.6993454' stopColor='#fdcd04' />
          <Stop offset='0.7712418' stopColor='#fdce05' />
          <Stop offset='0.8605661' stopColor='#ffce0a' />
        </RadialGradient>
        <Filter id='q' x='-.04842873' y='-.0582241' width='1.096857' height='1.116448'>
          <FeGaussianBlur stdDeviation='1.700914' />
        </Filter>
        <Filter id='k' x='-.01670084' y='-.01009856' width='1.033402' height='1.020197'>
          <FeGaussianBlur stdDeviation='0.2419367' />
        </Filter>
        <ClipPath id='i'>
          <Path
