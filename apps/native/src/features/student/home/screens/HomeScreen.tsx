      ...
      <View className='h-[178px] gap-[10px] px-[128px] pt-[16px]'>
        <View
          ...
          <View className='flex-row items-center gap-[12px]'>
            ...
            <View>
              ...
              <Text className='mt-1 text-[12px] text-[#6B6F77]' style={{ fontFamily: 'PretendardMedium' }}>
                오늘 12:00
              </Text>
            </View>
          </View>
          <Pressable className='h-[33px] items-center justify-center rounded-[6px] bg-[#3A67EE] px-[12px] py-[6px]'>
        ...
        <View
          ...
          <View className='gap-[10px] px-[10px]'>
            <Text className='color-[#3A67EE] text-[12px]' style={{ fontFamily: 'PretendardMedium' }}>
              더보기
            </Text>
          </View>
        </View>
