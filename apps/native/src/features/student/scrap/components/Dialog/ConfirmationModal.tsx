...
export const ConfirmationModal = ({
  ...
  return (
    <PopUpModal visibleState={visible} setVisibleState={onClose} className='px-2'>
      <View className='max-w-[458px] items-center justify-center gap-[24px] rounded-[12px] border border-gray-400 bg-white p-[28px] shadow-[0px_4px_4px_-4px_rgba(12,12,13,0.05),_0px_16px_32px_-4px_rgba(12,12,13,0.10)]'>
